...
if($test->error_code==0){
	...
	if($sotien==10000){$xu = 5;}
	else if($sotien==20000){$xu = 10;}
	else if($sotien==30000){$xu = 20;}
	else if($sotien==50000){$xu = 30;}
	else if($sotien==100000){$xu = 50;}
	else if($sotien==200000){$xu = 100;}
	else if($sotien==300000){$xu = 200;}
	else if($sotien==500000){$xu = 300;}
