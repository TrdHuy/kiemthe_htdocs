...
if($_POST['submit']) {
	...
	//	}
		if(!$e) {
			...
			$sqlInsert = "insert into account (loginName,password_hash,cEMail,cRealName,cPhone,cQuestion,cAnswer,checkMember) values('$username','$password','$email','$cmnd','$cPhone','$cauhoibimat','$traloicauhoi','1')";
		...
		$cPhone_update = $_POST['cPhone_update'];
...
<tr>
    ...
    <td>
        ...
        <span class="hi_r">* Dùng lấy lại mật khẩu</span>
...
<tr>
    ...
    <td>
        ...
        <input id="cPhone" name="cPhone" type="text" class="text-field" maxlength="500" value="<?=$cPhone;?>" />
...
<tr>
    ...
    <td>
        ...
        <input id="cPhone_update" name="cPhone_update" type="text" class="text-field" maxlength="500" value="<?=$rowUserInfo['cPhone'];?>" />
...
<tr>
    ...
    <td>
     ...
     <b><font color='red'><?=$rowUserInfo['xu'];?> Xu</font></b>
